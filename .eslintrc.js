...
//   ],
  ...
  "rules": {
      ...
      "max-len": [1, 200],//字符串最大长度
      "max-nested-callbacks": [0, 2],//回调嵌套深度
      "max-params": [0, 7],//函数最多只能有3个参数
      "max-statements": [1, 200],//函数内最多有几个声明
      ...
      "quote-props": ["error", "as-needed", { "keywords": true, "unnecessary": false, "numbers": true }],//对象字面量中的属性名是否强制双引号
